    ...
    <header>
        ...
        <nav className="main-menu d-flex navbar navbar-expand-lg ">
            ...
            <div className="offcanvas-body justify-content-between">
                ...
                <li className="nav-item">
                    <Link to="/products/list" className="nav-link">Productos</Link>
                </li>
                <li className="nav-item">
                    <a href="blog.html" className="nav-link">Usuarios</a>
                </li>
                <li className="nav-item">
                    <a href="contact.html" className="nav-link">Roles</a>
                </li>
                <li className="nav-item">
                    <a href="javascript;" className="nav-link">Mis pedidos</a>
                </li>
                </ul>
